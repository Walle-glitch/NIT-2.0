...
def setup(bot: commands.Bot):
    ...
    # Dynamically create choices from the dictionary keys
    ...
    # THIS COMMAND MUST BE DEFINED *INSIDE* THE SETUP FUNCTION
    ...
    # Note: The setup calls for other modules (Game, Auction, etc.) are
    # correctly handled in main.py and should NOT be here.